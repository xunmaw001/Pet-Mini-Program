    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商品信息" prop="shangpinxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangpinxinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinxinxi" label="商品信息" prop="shangpinxinxi">
                    <span v-html="ruleForm.shangpinxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxinxi = this.ruleForm.shangpinxinxi.replace(reg,'../../../ssm91oey/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
